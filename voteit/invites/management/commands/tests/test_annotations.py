...
class InviteAnnotationsIntegrationTests(TestCase):
    ...
    def test_group(self):
        self.call_command(m=self.meeting.pk, u=1, f=fixture_file("grouprole.csv"))
    ...
    def test_blank_roles_afterwards(self):
        ...
        self.call_command(m=self.meeting.pk, u=1, f=fixture_file("grouprole_blank.csv"))
        self.assertEqual(
            [None, None, None],
            [
                x["group_role_id"]
    ...
    def test_dryrun(self):
        self.call_command(
            m=self.meeting.pk, u=1, f=fixture_file("grouprole.csv"), dry_run=True
        )
