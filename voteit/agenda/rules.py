...
def is_non_private_ai(user: AbstractUser, agenda_item: AgendaItem):
...
# object permissions
@rules.predicate
def can_view_agenda(user: AbstractUser, agenda_item: AgendaItem):
...
@rules.predicate
def can_moderate_agendas_meeting(user: AbstractUser, agenda_item: AgendaItem):
