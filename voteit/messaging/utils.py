...
def cleanup_connection_status(
    secs=180, only_user: Optional[AbstractUser] = None
) -> Set[str]:
    """
    Check connections marked as active and make sure they're still active according to redis.
    Returns set of found connections.
    """
