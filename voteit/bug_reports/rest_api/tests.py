...
class BugReportRestTests(APITestCase):
    def setUp(self):
        ...
        self.meeting = Meeting.objects.create(title="Test meeting", organisation=self.org)
    ...
    def test_create(self):
        ...
        self.assertEqual(
            BugReport.objects.count(),
            1,
            "Bug report count wrong"
        )
    ...
    def test_list(self):
        ...
        self.assertEqual(
            response.status_code,
            HTTPStatus.OK,
            "Authenticated listing should be ok"
        )
        self.assertEqual(
            len(response.data),
            1,
            "Incorrect report list length"
        )
        self.assertEqual(
